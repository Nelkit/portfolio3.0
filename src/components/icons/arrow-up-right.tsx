...
const ArrowUpRight = ({width = 'w-4', height='h-4', otherClasses}: Props) =>{
    return (
        <svg  className={`${width} ${height} ${otherClasses}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14.4238 14.4434" fill="currentColor">
